...
Input three datasets. I split the ‘baker_name’ variable in the
...
Using anti_join() to check for completeness and correctness across
datasets
...
From the results, it is obvious that the baker ’' in bakes.csv and
baker.csv
